    ...
    return (
        <div className="fixed bottom-0 left-0 z-50 w-full h-16 bg-vinho border-t border-gray-200 dark:bg-gray-700 dark:border-gray-600">
                <div className="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
                    ...
                    : <Link to="/dashboard" className="inline-flex flex-col items-center justify-center px-5 hover:bg-marrom group"> 
                     <svg className="w-5 h-5 mb-2 text-marrom group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <span className="text-sm text-marrom group-hover:text-white">Home</span>
                    </Link>
                    }
                    {location.pathname == '/vender' ? 
                    <Link to="/vender" className="inline-flex flex-col items-center justify-center px-5 group bg-marrom">
                        <svg className="w-5 h-5 mb-2 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 11 20">
                    ...
                    <Link to="/relatorio" className="inline-flex flex-col items-center justify-center px-5 hover:bg-marrom group  bg-marrom">
                        <svg className="w-5 h-5 mb-2 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                            <path d="M16.975 11H10V4.025a1 1 0 0 0-1.066-.998 8.5 8.5 0 1 0 9.039 9.039.999.999 0 0 0-1-1.066h.002Z"/>
                            <path d="M12.5 0c-.157 0-.311.01-.565.027A1 1 0 0 0 11 1.02V10h8.975a1 1 0 0 0 1-.935c.013-.188.028-.374.028-.565A8.51 8.51 0 0 0 12.5 0Z"/>
                        </svg>
                        <span className="text-sm text-white">Relatório</span>
                    </Link>
                    :
                    ...
                    <Link to="/meu-perfil" className="inline-flex flex-col items-center justify-center px-5 hover:bg-marrom group  bg-marrom">
                        <svg className="w-5 h-5 mb-2 text-white " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
